...
const ImageUploadIcon = (props: { [key: string]: unknown }): JSX.Element => {
    return (
        <SvgIcon {...props} viewBox="0 0 308.8 308.8" enableBackground="new 0 0 308.8 308.8" xmlSpace="preserve">
            <g>
                <path
                    style={{ fill: '#4A566E' }}
